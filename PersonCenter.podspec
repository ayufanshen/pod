...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "fanshen"
  # s.authors            = { "fanshen" => "fanshen@zuche.com" }
  # s.social_media_url   = "http://twitter.com/fanshen"
  ...
  s.source  = { :git => "https://github.com/ayufanshen/pod.git", :tag => s.version }
  ...
  #  you can include multiple dependencies to ensure it works.
    ...
    s.dependency "'zucheLib_Networking', :git => 'http://10.3.4.127:8888/ios_team/zuchelib_networking.git"
    s.requires_arc         = true
